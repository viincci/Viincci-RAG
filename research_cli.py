#!/usr/bin/env python3
"""
research_cli.py - Enhanced CLI with Multiple Output Formats
...
Examples:
  ...
  # Plain text output
  python research_cli.py -q "diabetes" -d medical --format text
  ...
  python research_cli.py -q "Van Gogh" -d art_history --content-type poem --rag
  
  # Generate essay about music
  python research_cli.py -q "Baroque music" -d music --content-type essay --rag
  
  # Literature research with essay output
  python research_cli.py -q "Shakespeare sonnets" -d literature --content-type essay
        """
    )
